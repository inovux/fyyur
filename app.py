...
def search_venues():
    ...
    searched_venues = Venue.query.filter(Venue.name.ilike(search)).all()

    response = {
        "count": len(searched_venues),
        "data": [venue for venue in searched_venues]
    }
...
def search_artists():
    ...
    searched_artists = Artist.query.filter(Artist.name.ilike(search)).all()

    response = {
        "count": len(searched_artists),
        "data": [artist for artist in searched_artists]
    }
